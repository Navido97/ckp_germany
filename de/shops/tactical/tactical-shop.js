/**
 * tactical-shop.js
 * Product rendering and filtering for CKP Tactical Shop
 */
        ...
        try {
            ...
            if (window.loadSheetProducts) {
                ...
                if (sheetsProducts && sheetsProducts.length > 0) {
                    console.log('[TacticalShop] Using Sheets products:', sheetsProducts.length);
            ...
            <div class="product-card" data-product-id="${product.id}">
                ...
                <div class="product-content">
                    ...
                    <button class="product-cta">
                        ...
                        ${lang === 'de' ? 'ANFRAGE STELLEN' : 'INQUIRY FORM'}
                    </button>
                </div>
            </div>
        `;
