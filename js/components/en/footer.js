// EN Footer Component — GitHub Pages compatible (BASE: /ckp_germany/)
(function() {
    const footerHTML = `
        <style>
            ...
            <div class="footer-container">
                <div class="footer-content">
                    <div class="footer-section footer-about">
                        ...
                        <p>Your reliable partner for high-quality security and protective equipment. Professional solutions for emergency services.</p>
                    ...
                    <div class="footer-section">
                        ...
                        <ul class="footer-links">
                            ...
                            <li><a id="fl-about">About Us</a></li>
                            ...
                            <li><a id="fl-contact">Contact</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="footer-section">
                        ...
                        <div class="footer-contact-item">
                            ...
                            <div><p>CKP Germany GmbH<br>Kommodore-Johnsen-Boulevard 19<br>28217 Bremen, Germany</p></div>
                        </div>
                        <div class="footer-contact-item">
