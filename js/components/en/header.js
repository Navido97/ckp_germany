// EN Header Component — GitHub Pages compatible (BASE: /ckp_germany/)
(function() {
    const headerHTML = `
        <style>
            .header {
            ...
            <div class="header-container">
                ...
                <nav class="nav" id="nav">
                    <ul class="nav-links">
                        ...
                        <li><a href="" class="nav-link" id="nav-about">ABOUT US</a></li>
                        ...
                        <li><a href="" class="nav-link" id="nav-contact">CONTACT</a></li>
                    </ul>
    ...
    function insertHeader() {
        ...
        document.getElementById('nav-home').href          = BASE + 'en/index.html';
        document.getElementById('nav-about').href         = BASE + 'en/about.html';
        document.getElementById('nav-contact').href       = BASE + 'en/contact.html';
        document.getElementById('dd-tactical').href       = BASE + 'en/shops/tactical/tactical.html';
        document.getElementById('dd-care').href           = BASE + 'en/shops/care/care.html';
        document.getElementById('dd-merch').href          = BASE + 'en/shops/merch/merch.html';
        document.getElementById('dd-workwear').href       = BASE + 'en/shops/workwear/workwear.html';
